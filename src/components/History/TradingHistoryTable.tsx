      ...
      {connectedWallet ? (
        <TableContainer>
          <Table sx={{ whiteSpace: "nowrap" }}>
            <TableHead>
              <TableRow>
                <TableCell align="left">{t("opened")}</TableCell>
                <TableCell align="left">{t("value")}</TableCell>
                <TableCell align="left">{t("type")}</TableCell>
                <TableCell align="left">{t("entry")}</TableCell>
                <TableCell align="left">{t("ratio")}</TableCell>
                <TableCell align="left">{t("payments")}</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {rows.map((row, index) => (
